...
* 镜像地址：
  - Aliyun仓库：registry.cn-shenzhen.aliyuncs.com/colovu/kafka:2.3
  - DockerHub：colovu/kafka:2.3
...
$ curl -sSL -o https://gitee.com/colovu/docker-kafka/raw/2.3/docker-compose.yml

# 从 Github 下载 Compose 文件
$ curl -sSL -o https://raw.githubusercontent.com/colovu/docker-kafka/2.3/docker-compose.yml
...
```shell
$ docker run -d -e "KAFKA_ZOOKEEPER_CONNECT=zookeeper:2181" --name kafka1 colovu/kafka:2.3
```
